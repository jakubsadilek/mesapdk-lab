...
logo = svg_logo(
        svg_path="./static/Logo_UTKU.svg",
        layer=(5,0),
        target_width_um=700.0,   # final width in um
...
"""
if VERBOSE:
    print("Placing dies on wafer map...")
...
"""
if VERBOSE:
    print("Adding wafer-level labels and logo...")
...
"""
if VERBOSE:
    print("Filling wafer with tiles for better etch uniformity...")
fc = gf.Component()
...
if VERBOSE:
    print("Exporting GDS and OAS files...")
wafer_filled.show()
if EXPORT_FILES:
