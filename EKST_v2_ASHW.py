...
from ekin_master_die import ekn_master_die_ds_xl, edge_coupler_array_ekn_def, edge_coupler_array_ekn_def_centerskip, edge_coupler_array_ekn_def_butt
...
def ekst_v2_uwwg_master(
        ...
        label: str = "EKAJ_v0\nUWWG",
        chip_id_label: str = "EKAJ_v0 UWWG\nW00_I00\nX20.0 Y20.0",
...
#TODO: This is plain hack ... if there would be odd number of al. loops it would fall apart
    ...
    if label != None:
        tag = d.add_ref(label_txt(size=100, text=label)).dmove(origin=(0,0), destination=(0, 3000))
