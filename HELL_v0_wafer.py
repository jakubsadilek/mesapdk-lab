...
from ekin_master_die import edge_coupler_array_ekn_def_butt, edge_coupler_array_ekn_def_3loops_narrow, edge_coupler_array_ekn_def_narrow, edge_coupler_array_ekn_def_centerskip
...
BRT_TAPN = gf.partial(ekst_v2_brt_master,
                     ext_grp_spacing=127,
...
PUL_TAPN_DEF=[]
for i in range(0, len(widths)):
    PUL_TAPN_DEF.append(gf.partial(ekst_v2_pul_master, 
                                  width = (widths[i],),
...
assign_array[(0, -2)] = PUL_TAPN_DEF[1]
assign_array[(1, -2)] = PUL_TAPN_DEF[0]
assign_array[(-1, -1)] = PUL_TAP_DEF[0]
assign_array[(0, -1)] = PUL_TAPN_DEF[3]
assign_array[(1, -1)] = PUL_TAPN_DEF[2]
assign_array[(2, -1)] = PUL_TAP_DEF[3]
assign_array[(-1, 0)] = PUL_TAP_DEF[1]
assign_array[(0, 0)] = BRT_TAPN
assign_array[(1, 0)] = BRT_TAP
assign_array[(2, 0)] = PUL_TAP_DEF[2]
assign_array[(-1, 1)] = PUL_TAP_DEF[2]
assign_array[(0, 1)] = BRT_TAP
assign_array[(1, 1)] = BRT_TAPN
assign_array[(2, 1)] = PUL_TAP_DEF[1]
assign_array[(-1, 2)] = PUL_TAP_DEF[3]
assign_array[(0, 2)] = PUL_TAPN_DEF[3]
assign_array[(1, 2)] = PUL_TAPN_DEF[2]
assign_array[(2, 2)] = PUL_TAP_DEF[0]
assign_array[(0, 3)] = PUL_TAP_DEF[0]
assign_array[(1, 3)] = PUL_TAPN_DEF[1]
